...
<form method="post" action="/apply.cgi?/securityquestions.cgi">
...
<TR><TD colSpan=2>&nbsp;</TD></TR>
<TR>
	<TD nowrap align="right" style="width: 250px;">$security_question #1*:</TD>
	<TD nowrap align="left">
	<script>
		var ques1="<% cfg_get("PWD_question1") %>";
...
<TR>
        <TD nowrap align="right">$security_question #2*:</TD>
        <TD nowrap align="left">
        <script>
                var ques2="<% cfg_get("PWD_question2") %>";
