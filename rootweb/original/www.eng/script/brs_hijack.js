...
function showLoginInfoPage()
{
        if(parent.is_reenter == 1)
            this.location.href = "BRS_03A_B_pppoe_reenter.html";
        else
            this.location.href = "BRS_03A_B_pppoe.html";            
}

function PPPoE_helpme(is_att)
{
    if(is_att == 1)
    {
        window.open('http://att.net/activate','att_win',"width=800,height=600,status=yes,resizable=yes")
		this.location.href="BRS_03A_B_pppoe_att_cfg.html";
    }
    else
    	this.location.href = "BRS_03A_B_HelpMe_selectISP.html";
}
