cmd_networking/sendarp.o := /opt/toolchains/uclibc-crosstools-gcc-4.4.2-1-with-ftw/usr/bin/mips-linux-gcc -Wp,-MD,networking/.sendarp.o.d   -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -D"BB_VER=KBUILD_STR(1.13.4)" -DBB_BT=AUTOCONF_TIMESTAMP  -Wall -Wshadow -Wwrite-strings -Wundef -Wstrict-prototypes -Wunused -Wunused-parameter -Wmissing-prototypes -Wmissing-declarations -Wdeclaration-after-statement -Wold-style-definition -fno-builtin-strlen -finline-limit=0 -fomit-frame-pointer -ffunction-sections -fdata-sections -fno-guess-branch-probability -funsigned-char -static-libgcc -falign-functions=1 -falign-jumps=1 -falign-labels=1 -falign-loops=1 -Os    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(sendarp)"  -D"KBUILD_MODNAME=KBUILD_STR(sendarp)" -c -o networking/sendarp.o networking/sendarp.c

deps_networking/sendarp.o := \
  networking/sendarp.c \
  ...
  /opt/toolchains/uclibc-crosstools-gcc-4.4.2-1-with-ftw/usr/include/linux/if_packet.h \
  /opt/toolchains/uclibc-crosstools-gcc-4.4.2-1-with-ftw/usr/include/linux/types.h \
  /opt/toolchains/uclibc-crosstools-gcc-4.4.2-1-with-ftw/usr/include/asm/types.h \
  /opt/toolchains/uclibc-crosstools-gcc-4.4.2-1-with-ftw/usr/include/asm-generic/int-ll64.h \
  /opt/toolchains/uclibc-crosstools-gcc-4.4.2-1-with-ftw/usr/include/linux/posix_types.h \
  /opt/toolchains/uclibc-crosstools-gcc-4.4.2-1-with-ftw/usr/include/linux/stddef.h \
  /opt/toolchains/uclibc-crosstools-gcc-4.4.2-1-with-ftw/usr/include/asm/posix_types.h \
  /opt/toolchains/uclibc-crosstools-gcc-4.4.2-1-with-ftw/usr/include/net/if.h \
  ...
  /opt/toolchains/uclibc-crosstools-gcc-4.4.2-1-with-ftw/usr/include/netinet/if_ether.h \
  /opt/toolchains/uclibc-crosstools-gcc-4.4.2-1-with-ftw/usr/include/linux/if_ether.h \
  /opt/toolchains/uclibc-crosstools-gcc-4.4.2-1-with-ftw/usr/include/net/ethernet.h \
  /opt/toolchains/uclibc-crosstools-gcc-4.4.2-1-with-ftw/usr/include/net/if_arp.h \
  include/busybox.h \
...
networking/sendarp.o: $(deps_networking/sendarp.o)
