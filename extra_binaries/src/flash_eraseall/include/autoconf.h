 ...
 */
#define AUTOCONF_TIMESTAMP "2016-08-11 12:40:02 BST"
...
#define USE_FEATURE_SYSLOG(...)
#define SKIP_FEATURE_SYSLOG(...) __VA_ARGS__
...
#define CONFIG_CROSS_COMPILER_PREFIX "/opt/toolchains/uclibc-crosstools-gcc-4.4.2-1-with-ftw/usr/bin/mips-linux-"
...
#define ENABLE_SENDARP 0
#define USE_SENDARP(...)
#define SKIP_SENDARP(...) __VA_ARGS__
#undef CONFIG_BRCTL
...
#define USE_FEATURE_SH_IS_NONE(...) __VA_ARGS__
#define SKIP_FEATURE_SH_IS_NONE(...)
#undef CONFIG_ASH
#define ENABLE_ASH 0
#define USE_ASH(...)
