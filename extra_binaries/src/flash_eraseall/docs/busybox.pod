...
Currently available applets include:
	...
	flash_eraseall, fold, free, freeramdisk, fsck, fsck_minix, 
	...
	ifup, inetd, init, inotifyd, insmod, install, ip, ipaddr, ipcalc, 
	...
	lsmod, lzmacat, makedevs, makemime, man, matchpathcon, md5sum, 
	...
	parse, passwd, patch, pgrep, pidof, ping, ping6, pipe_progress, 
	...
	selinuxenabled, sendarp, sendmail, seq, sestatus, setarch, 
	setconsole, setenforce, setfiles, setfont, setkeycodes, 
	setlogcons, setsebool, setsid, setuidgid, sh, sha1sum, showkey, 
	slattach, sleep, softlimit, sort, split, start_stop_daemon, stat, 
	...
	touch, tr, traceroute, true, tty, ttysize, tune2fs, udhcpc, 
...
flash_eraseall Erase flash device
...
grep       [B<-HhrilLnqvsoweFEABC>] PATTERN [FILEs...]
...
mountpoint [B<-q>] <[B<-d>] DIR | B<-x> DEVICE>
...
rtcwake    [B<-a> | B<-l> | B<-u>] [B<-d> DEV] [B<-m> MODE] [B<-s> SECS | B<-t> TIME]
...
sendarp    B<-s> <src device name> B<-d> <dst device name>
